package com.czarnecki.food.ordering.kafka.consumer.config;

import com.czarnecki.food.ordering.kafka.config.data.KafkaConfigData;
import com.czarnecki.food.ordering.kafka.config.data.KafkaConsumerConfigData;
