...
import com.czarnecki.food.ordering.service.domain.exception.OrderDomainException;
...
public class OrderCreateCommandHandler {
    ...
    private Restaurant checkRestaurant(CreateOrderCommand createOrderCommand) {
        ...
        if (optionalRestaurant.isEmpty()) {
            log.warn("Could not find restaurant with restaurand id: {}", createOrderCommand.getRestaurantId());
            throw new OrderDomainException("Could not find restaurant with restaurand id: "
